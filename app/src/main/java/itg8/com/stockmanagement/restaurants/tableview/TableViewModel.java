...
//         initialize drawables
        mBoyDrawable = R.drawable.ic_action_phone;
        mGirlDrawable = R.drawable.ic_action_phone;
        mHappyDrawable = R.drawable.ic_action_phone;
        mSadDrawable = R.drawable.ic_action_phone;
    }
...
//                }
            ...
            list.add(cellList);
            Log.d(TAG, "getCellListForSortingTest:  cell list"+ new Gson().toJson(cellList));
        }

        Log.d(TAG, "getCellListForSortingTest final list: "+ new Gson().toJson(list));
        return list;
    }
