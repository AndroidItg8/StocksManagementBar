...
package itg8.com.stockmanagement.restaurants.tableview.holder;
...
public class ColumnHeaderViewHolder extends AbstractSorterViewHolder {
    ...
    private void controlSortState(@NonNull SortState sortState) {
        if (sortState == SortState.ASCENDING) {
            ...
            column_header_sortButton.setImageResource(R.drawable.ic_arrowbackward);

        } else if (sortState == SortState.DESCENDING) {
            column_header_sortButton.setVisibility(View.VISIBLE);
            column_header_sortButton.setImageResource(R.drawable.ic_arrowforward);
        } else {
